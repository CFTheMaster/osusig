<html>
    <head>
        ...
        <meta name='author' content='computerfreaker'>
    ...
    <body>
        ...
        <article style="text-align: center;">
            ...
            <input type="text" placeholder="computerfreaker" name="uname" id="uname" />
            <br><br>
        ...
        <article style="text-align: center;">
            <div id="previewarea">
                <img src="sig.php?colour=pink&uname=computerfreaker" class="preview lazy" width="338" height="94">
            </div>
            <br>
            <label for="out">BBCode:</label>
            <input type="text" name="out" id="out" value="[img]http://osu.computerfreaker.pw/sig.php?colour=pink&uname=computerfreaker[/img]" style="width: 100%; text-align: center" readonly />
            <br><br>
